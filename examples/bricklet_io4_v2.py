...
async def run_example(bricklet: BrickletIO4V2) -> None:  # pylint: disable=too-many-statements
    ...
    try:
        ...
        print("Enabling edge count callback with 500 ms period")
        await bricklet.set_edge_count_callback_configuration(channel=2, period=500)
        ...
        await bricklet.set_edge_count_callback_configuration(channel=2)
        print("Disabled edge count callback")
        await asyncio.sleep(0.5)
