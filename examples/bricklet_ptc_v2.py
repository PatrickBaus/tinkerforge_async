...
"""
An example to demonstrate most of the capabilities of the Tinkerforge PTC Bricklet 2.0.
"""
import asyncio
import warnings
from decimal import Decimal

from tinkerforge_async.bricklet_ptc_v2 import BrickletPtcV2
from tinkerforge_async.devices import BrickletWithMCU
from tinkerforge_async.ip_connection import IPConnectionAsync


async def process_callbacks(device: BrickletPtcV2) -> None:
...
async def run_example(bricklet: BrickletPtcV2) -> None:
    ...
    try:
        ...
        await asyncio.gather(
            bricklet.set_temperature_callback_configuration(period=1000),
            bricklet.set_resistance_callback_configuration(period=1000),
    ...
    try:
        ...
        async with IPConnectionAsync(host="127.0.0.1", port=4223) as connection:
            ...
            async for enumeration_type, device in connection.read_enumeration():  # pylint: disable=unused-variable
                if isinstance(device, BrickletPtcV2):
